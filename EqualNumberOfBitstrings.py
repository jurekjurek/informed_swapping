...
This will be a simple study comparable to SystematicStudy.py, but with a different approach. 
This time, BARK and SKQD will be run until they finish, no target fidelity is set.
Afterwards, the comparison will be the averaged fidelity against the number of states. 
...
DEFAULT_MAX_INTERACTIONS = [1, 2, 3]
...
COLUMNS = ["Hamiltonian_Index", "Number_of_Sites", "Max_Interactions", "Penalty_Strength",
